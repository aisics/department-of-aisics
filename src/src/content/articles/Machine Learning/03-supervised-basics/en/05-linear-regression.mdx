...
import LinearRegressionScatter from '../../../../../components/LinearRegressionScatter.astro';
...
<LinearRegressionScatter
  title="Temperature vs Pizza Sales"
...
<LinearRegressionScatter
  ...
  regressionParams={JSON.stringify({intercept: 35, slope: -0.5})}
/>

The line formula:

```
pizzas = 35 - 0.5 × temperature
```
